      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Panel Owner</Text>
          </View>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <Text style={styles.loginButtonText}>Masuk sebagai Owner</Text>
                </>
              )}
            </Pressable>
          </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: FontSizes.base, color: Colors.warning, marginTop: Spacing.xs, fontWeight: Fonts.semibold },
  formCard: {
