...
func main() {
	...
	urls := map[string]string{
		...
		"P-002": "http://localhost:8000/images/products/semen_gresik.png",
		"P-005": "http://localhost:8000/images/products/semen_panda.png",
		"P-006": "http://localhost:8000/images/products/semen_tiga_roda.png",
		"P-010": "http://localhost:8000/images/products/semen_drymix.png",
		"P-011": "http://localhost:8000/images/products/semen_sika_granit.png",
	}
